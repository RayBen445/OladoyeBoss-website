...
window.QuotesData = {
    ...
    biblical: [
        ...
        // Additional Biblical quotes from expanded collection
        {
        ...
        {
            text: "Therefore, since such a great cloud of witnesses surrounds us, let us throw off everything that hinders and the sin that so easily entangles. And let us run with perseverance the race marked out for us, fixing our eyes on Jesus, the pioneer and perfecter of faith.",
        ...
        {
            text: "Now to him who can do immeasurably more than all we ask or imagine, according to his power that is at work within us.",
        ...
        {
            text: "No temptation has overtaken you except what is common to humanity. And God is faithful; he will not let you be tempted beyond what you can bear. But when you are tempted, he will also provide a way out so that you can endure it.",
        ...
        },
        {
            ...
            author: "2 Timothy 4:7-8",
            category: "Victory"
        },
        {
            text: "We were therefore buried with him through baptism into death so that, just as Christ was raised from the dead through the glory of the Father, we too may live a new life.",
            author: "Romans 6:4",
            category: "New Life"
        },
        {
        ...
        {
            text: "I lift my eyes to the mountains—where does my help come from? My help comes from the Lord, the Maker of heaven and earth.",
        ...
        {
            text: "And God can bless you abundantly, so that in all things at all times, having all that you need, you will abound in every good work.",
        ...
        {
            text: "Let love and faithfulness never leave you; bind them around your neck, write them on the tablet of your heart. Then you will win favor and a good name in the sight of God and man.",
            author: "Proverbs 3:3-4",
            category: "Character"
        },
        {
